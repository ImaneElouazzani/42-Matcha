...
function createDescendantContext(name, initialValue) {
  ...
  var descendants = [];
  return context.createNamedContext(name, _extends({
    descendants: descendants,
    registerDescendant: noop.noop,
    unregisterDescendant: noop.noop
  }, initialValue));
}
/**
...
function useDescendant(descendant, context, indexProp) {
  ...
  var previousDescendants = usePrevious.usePrevious(descendants); // We also need to re-register descendants any time ANY of the other
